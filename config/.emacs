...
;(global-set-key [f12] 'spell-region)
...
;(global-set-key [f11] 'search-forward-regexp)
;(Global-set-key [f12] 'search-backward-regexp)
...
;; This is how emacs tells the file type by the suffix
...
(cond
 ((and (string-match "XEmacs" emacs-version)
  ...
  (load-options-file "/home/ttabion1/.xemacs-options")))
